...
ambiente = AmbienteMaritimo(largura=350, altura=400, num_navios=30)

# Criar o VANT e definir a rota de patrulha
vant = VANT(x=50.0, y=100.0, velocidade=60.0, autonomia=2000.0,
            alcance_radar=100.0, alcance_camera=20.0, politica="greed")
