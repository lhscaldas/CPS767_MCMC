...
\begin{enumerate}
    ...
    \begin{tcolorbox}[colframe=black, title=Resposta:]
        ...
        O dado uniforme possui uma variância maior, ou seja, é esperado que haja uma distância numérica maior entre seus valores tirados em comparação com o outro dado.
    \end{tcolorbox}
\end{enumerate}
